...
The desktop app SHALL provide a navigation drawer that exposes supported global destinations and account actions without leaving users in dead-end UI states.

#### Scenario: User opens navigation drawer
- **WHEN** the user activates the sidebar menu button
- **THEN** the desktop app SHALL open a navigation drawer containing theme controls, profile, settings, about, and logout actions
