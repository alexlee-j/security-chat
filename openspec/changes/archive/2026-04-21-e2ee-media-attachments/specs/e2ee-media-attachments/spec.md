...
The desktop client SHALL encrypt image, audio, and file attachment bytes before uploading them to backend media storage.
...
- **WHEN** a user selects a non-image non-audio file and sends it as a message
