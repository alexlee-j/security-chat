# realtime-call-signaling Specification

## Purpose
Define authenticated backend signaling for one-to-one desktop voice calls, including authorization, multi-device ringing, first-accept-wins behavior, offline handling, WebRTC negotiation relay, and media persistence boundaries.
