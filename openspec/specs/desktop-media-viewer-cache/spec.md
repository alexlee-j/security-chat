# desktop-media-viewer-cache Specification

## Purpose
Define desktop in-app media preview behavior and local decrypted file cache behavior for image, video, and generic file attachments.
