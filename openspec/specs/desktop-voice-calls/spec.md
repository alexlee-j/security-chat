# desktop-voice-calls Specification

## Purpose
Define desktop one-to-one voice call behavior, UI lifecycle states, local audio resource handling, WebRTC media transport boundaries, and ICE configuration expectations.
