# desktop-voice-messages Specification

## Purpose
Define desktop voice message recording, encrypted sending, and playback behavior for the current development branch.
...
The desktop client SHALL render voice messages with duration, waveform, playback progress, pause/resume control, and error states.
